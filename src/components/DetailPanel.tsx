        ...
        <div className="h-full flex flex-col lg:flex-row gap-6 overflow-y-auto lg:overflow-hidden">
                ...
                <div className="mb-6">
                    <div className="flex items-start justify-between gap-4 mb-4">
                        ...
                        <a
                            ...
                            className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg dark:text-blue-400 dark:hover:bg-blue-900/30 flex-shrink-0"
            ...
            {node.type === 'url' && (
                <div className="flex-none lg:flex-1 lg:max-w-[50%] flex flex-col min-h-[500px] lg:min-h-0 pb-6 lg:pb-0">
                    ...
                    {/* Browser Chrome */}
                    <div className="flex-1 flex flex-col bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-2 flex items-center gap-2">
                            ...
                            <div className="flex-1 bg-white dark:bg-gray-900 rounded px-3 py-1 text-xs text-gray-500 truncate mx-4 text-center">
                                {node.url}
                            </div>
                        </div>
                        <div className="flex-1 relative bg-white">
                            <iframe
                                ...
                                title="Preview"
                            />
                            {/* Removed overlay to allow interaction if desired, or keep it if interaction is buggy */}
                        </div>
                    </div>
